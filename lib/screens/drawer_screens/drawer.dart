          ...
          builder: (controller) {
            return Column(
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    logOutWarning(context, isDarkMode, controller);
                  },
                  child: Container(
                    height: height * 0.12,
                    margin: EdgeInsets.only(
...
Future logOutWarning(BuildContext context, theme, GetxController controller) {
  return showDialog(
    context: context,
    builder: (context) {
      return AlertDialog(
